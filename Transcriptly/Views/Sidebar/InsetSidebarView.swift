                ...
                ForEach(SidebarSection.allCases, id: \.self) { section in
                    ...
                    .onTapGesture {
                        if section.isEnabled {
                            withAnimation(UIPolishDesignSystem.Animation.selection) {
                    ...
                    .onHover { hovering in
                        withAnimation(UIPolishDesignSystem.Animation.quick) {
...
struct InsetSidebarItemView: View {
    ...
    var body: some View {
        ...
        .animation(UIPolishDesignSystem.Animation.quick, value: isHovered)
    }
