...
struct ProviderPreferences: Codable, Sendable {
    ...
    var fileTranscriptionProvider: ProviderType = .apple
    ...
    var openaiFileTranscriptionModel: String = "whisper-1"
...
struct OpenAIModels: Sendable {
    static let transcriptionModels = [
        "gpt-4o-mini-transcribe": "GPT-4o Mini Transcribe",
        "gpt-4o-transcribe": "GPT-4o Transcribe"
    ]
    
    static let fileTranscriptionModels = [
        "whisper-1": "Whisper-1 (Most accurate)",
        "gpt-4o-audio-preview": "GPT-4o Audio Preview (Faster)"
    ]
...
struct GoogleCloudModels: Sendable {
    static let ttsVoices = [
        // US English Voices
...
struct ElevenLabsModels: Sendable {
    static let ttsVoices = [
        // American English
...
struct OpenRouterModels: Sendable {
