...
struct ModeIndicator: View {
        ...
        Menu {
            ...
            HStack(spacing: 8) {
                ...
                Text(currentMode.displayName)
                    .font(UIPolishDesignSystem.Typography.modeIndicator)
            ...
            .cornerRadius(UIPolishDesignSystem.modeIndicatorCornerRadius)
            .overlay(
                RoundedRectangle(cornerRadius: UIPolishDesignSystem.modeIndicatorCornerRadius)
    ...
    private var backgroundMaterial: some View {
        if isHovered {
            Rectangle()
                .fill(UIPolishDesignSystem.cardContrastMaterial)
        } else {
            Rectangle()
