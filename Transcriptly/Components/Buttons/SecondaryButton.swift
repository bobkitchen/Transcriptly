...
struct PrimaryButtonStyle: SwiftUI.ButtonStyle {
    ...
    func makeBody(configuration: ButtonStyleConfiguration) -> some View {
        PrimaryButtonView(configuration: configuration, accentColor: accentColor)
    }
...
struct RecordButtonStyle: SwiftUI.ButtonStyle {
    ...
    func makeBody(configuration: ButtonStyleConfiguration) -> some View {
        RecordButtonView(configuration: configuration, isRecording: isRecording, recordingTime: recordingTime)
    }
